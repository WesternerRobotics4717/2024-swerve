...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private final ADXRS450_Gyro gyro1 = new ADXRS450_Gyro();
    private final SwerveDriveOdometry odometer = new SwerveDriveOdometry(DriveConstants.kDriveKinematics,
       new Rotation2d(gyro1.getAngle()), new SwerveModulePosition[] {frontLeft.getPosition(), frontRight.getPosition(), backLeft.getPosition(), backRight.getPosition()} );
    ...
    public double getHeading() {
        return Math.IEEEremainder(gyro1.getAngle(), 360);
    }
